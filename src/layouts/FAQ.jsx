...
const FAQ = () => {
  return (
    <div className="w-full grid place-items-center my-4 ">
      ...
      {/* <Accordion className="bg-white w-[80%] p-4"> */}
      {/* <Accordion.Panel>
          ...
          <Accordion.Content>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              ...
              programs. <br />
              Fix Health shares the same investors as companies like Ola,
              Snapdeal & Khatabook and the technology innovation is done by a
              team from IIT Bombay, IIT Madras & BITS Pilani.
            </p>
          </Accordion.Content>
        </Accordion.Panel> */}
      ...
      <AccordinaLayout title={" I Want to Know more about Fix Health"}>
        <>
          ...
          <p>
            ...
            <strong> Economic Times, Business World, Times of India </strong>for
            its effective online pain relief programs. <br />
            <br />
      ...
      {/* <Accordion.Panel>
          <Accordion.Title>
            I Want to Know more about Fix Health
          </Accordion.Title>
          <Accordion.Content>
            <p className="">
              Fix Health (YourPhysio previously) was started by Dr. Sheetal
      ...
      {/* <Accordion.Panel>
          <Accordion.Title>
            What will happen in the cunsultation?
          </Accordion.Title>
          <Accordion.Content>
